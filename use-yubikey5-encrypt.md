- [准备工作](#准备工作)
  - [安装 gpg](#安装gpg)
  - [安装 yubikey manager](#安装yubikey-manager)
- [GPG 密钥](#GPG密钥)
  - [创建主密钥](#创建主密钥)
  - [创建子证书](#创建子证书)
  - [备份密钥](#备份密钥)
- [yubikey 操作](#yubikey操作)
  ...
  - [上传公钥到 Key Server](#上传公钥到KeyServer)
  - [在另一台电脑使用 yubikey](#在另一台电脑使用yubikey)
  - [从 yubikey 中同步](#从yubikey中同步)
- [加解密的使用](#加解密的使用)
  - [加密文件](#加密文件)
  - [解密文件](#解密文件)
  - [使用 python 解密文件或数据](#使用python解密文件或数据)
